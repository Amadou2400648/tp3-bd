...
-- Suppression de tous les privilèges directs sur les tables pour LECT_LAB
REVOKE SELECT, INSERT, UPDATE, DELETE ON CHERCHEUR FROM LECT_LAB;
REVOKE SELECT, INSERT, UPDATE, DELETE ON EXPERIENCE FROM LECT_LAB;
REVOKE SELECT, INSERT, UPDATE, DELETE ON PROJET FROM LECT_LAB;
REVOKE SELECT, INSERT, UPDATE, DELETE ON ECHANTILLON FROM LECT_LAB;
REVOKE SELECT, INSERT, UPDATE, DELETE ON AFFECTATION_EQUIP FROM LECT_LAB;
REVOKE SELECT, INSERT, UPDATE, DELETE ON LOG_OPERATION FROM LECT_LAB;
